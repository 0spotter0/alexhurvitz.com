...
export default function LandingPage() {
  return (
    <main className="min-h-screen flex flex-col sm:flex-row">
      <Link
        href="/photo"
        className="flex-1 flex flex-col items-center justify-center min-h-[50vh] sm:min-h-screen px-10 py-16 group transition-colors duration-300 hover:bg-stone-100"
      >
        ...
        <span className="mt-6 text-xs tracking-widest uppercase text-gray-300 group-hover:text-gray-500 transition-colors duration-300">
          Enter →
        </span>
      </Link>
