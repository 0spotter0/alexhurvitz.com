      ...
      <div className="flex flex-col items-center gap-8 w-full">
        ...
        <div className="space-y-4 w-full sm:w-3/4 pb-10">
          <p>
            ...
            photography is its ability to tell stories and preserve emotion in a
            single frame.
          </p>
          <p>
            Beyond photography, Alex is also a jazz pianist and composer, with a
            deep passion for blending visual art and music together. One of
