        ...
        <div className="text-gray-600 leading-relaxed flex flex-col md:flex-row justify-between gap-10">
          <div className="md:w-6/10 flex flex-col gap-4">
            <p>
              ...
              their own musical emotions. He began studying classical piano at
              the age of three, and when a sophomore at the Los Angeles County
              High School for the Arts, discovered jazz, which formed the
              foundation of an artistic practice now spanning classical
              tradition, jazz performance, and contemporary creative work that
              blends structured interpretation with improvisation and creative
              exploration.
            </p>
            <p>
              As a performer, Alex has appeared with ensembles including the
              Brent Wallarab Big Band, Wayne Wallace Latin Jazz Big Band, John
              Raymond Big Band, and Rodney Whitaker Big Band. His work has been
              shaped through collaborations and mentorship within the jazz and
            ...
            <p>
              ...
              Competition and received the ASCAP Charlotte V. Bergen
              Scholarship, before going on to win the ASCAP Herb Alpert Young
              Jazz Composers Award the following year.
            </p>
            <p>
              Alex recently earned his Bachelor of Music degree in jazz piano
              from Indiana University, Jacobs School of Music, where he studied
              with artists Luke Gillespie, Sean Dobbins, Greg Ward, Brent
              Wallarab, and John Raymond. Alex has also studied with artists
              David Dzubay, Don Freund, PQ Phan, Alex Hahn, Daniel Rotem, Jeremy
              Siskind, Glenn Zaleski, Tierney Sutton, and Christian Jacob.
            </p>
            <p>
              ...
              music, and teaches piano students of all ages. He continues to
              study jazz voice while expanding his creative work in photography,
